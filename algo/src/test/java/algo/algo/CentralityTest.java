...
public class CentralityTest
{
    ...
    public void shouldHandleEmptyNodeSetWhenUsingBetweenness()
    {
        ...
        assertExpectedResult( 0, "CALL algo.algo.betweenness(['TYPE'],[],'BOTH')" + "" );
    }
    ...
    {
        db.execute( RANDOM_GRAPH ).close();
        assertExpectedResult( 0, "CALL algo.algo.closeness(['TYPE'],[],'BOTH')" + "" );
    }
    ...
    {
        db.execute( RANDOM_GRAPH ).close();
        assertExpectedResult( 50, algoQuery( "CALL algo.algo.betweenness([],nodes,'BOTH')" ) );
    }
    ...
    {
        db.execute( RANDOM_GRAPH ).close();
        assertExpectedResult( 50, algoQuery( "CALL algo.algo.closeness([],nodes,'BOTH')" ) );
    }
    ...
    {
        db.execute( RANDOM_GRAPH ).close();
        assertResultsAreEqual( algoQuery( "CALL algo.algo.betweenness([],nodes,'BOTH')" ),
                algoQuery( "CALL algo.algo.betweenness(['TYPE'],nodes,'BOTH')" ) );
    }
    ...
    {
        db.execute( RANDOM_GRAPH ).close();
        assertResultsAreEqual( algoQuery( "CALL algo.algo.closeness([],nodes,'BOTH')" ),
                algoQuery( "CALL algo.algo.closeness(['TYPE'],nodes,'BOTH')" ) );
    }
    ...
    {
        db.execute( RANDOM_GRAPH ).close();
        String algo = "CALL algo.algo.betweenness(['BAD_VALUE'],nodes,'BOTH')";
    ...
    {
        db.execute( RANDOM_GRAPH ).close();
        assertExpectedResult( 0, algoQuery( "CALL algo.algo.closeness(['BAD_VALUE'],nodes,'BOTH')" ) );
    }
    ...
    {
        db.execute( RANDOM_GRAPH ).close();
        assertExpectedResult( 0, algoQuery( "CALL algo.algo.betweenness([],null,'BOTH')" ) );
    }
    ...
    {
        db.execute( RANDOM_GRAPH ).close();
        assertExpectedResult( 0, algoQuery( "CALL algo.algo.closeness([],null,'BOTH')" ) );
    }
    ...
    {
        db.execute( RANDOM_GRAPH ).close();
        assertExpectedResult( 0, algoQuery( "CALL algo.algo.betweenness(null,nodes,'BOTH')" ) );
    }
    ...
    {
        db.execute( RANDOM_GRAPH ).close();
        assertExpectedResult( 0, algoQuery( "CALL algo.algo.closeness(null,nodes,'BOTH')" ) );
    }
    ...
    {
        db.execute( RANDOM_GRAPH ).close();
        assertExpectedResult( 0, algoQuery( "CALL algo.algo.betweenness(null,nodes,'null')" ) );
    }
    ...
    {
        db.execute( RANDOM_GRAPH ).close();
        assertExpectedResult( 0, algoQuery( "CALL algo.algo.closeness(null,nodes,'null')" ) );
    }
    ...
    {
        db.execute( RANDOM_GRAPH ).close();
        assertExpectedResult( 50, algoQuery( "CALL algo.algo.betweenness(['TYPE'],nodes,'OUTGOING')" ) );

        assertExpectedResult( 50, algoQuery( "CALL algo.algo.betweenness(['TYPE'],nodes,'INCOMING')" ) );

        assertExpectedResult( 50, algoQuery( "CALL algo.algo.betweenness(['TYPE'],nodes,'BOTH')" ) );
    }
    ...
    {
        db.execute( RANDOM_GRAPH ).close();
        assertExpectedResult( 50, algoQuery( "CALL algo.algo.closeness(['TYPE'],nodes,'OUTGOING')" ) );

        assertExpectedResult( 50, algoQuery( "CALL algo.algo.closeness(['TYPE'],nodes,'INCOMING')" ) );

        assertExpectedResult( 50, algoQuery( "CALL algo.algo.closeness(['TYPE'],nodes,'BOTH')" ) );
    }
...
// ==========================================================================================
    ...
    {
        db.execute( RANDOM_GRAPH ).close();
        assertExpectedResult( 0, algoQuery( "CALL algo.algo.betweenness(null,nodes,'INVAlid')" ) );
    }
    ...
    {
        db.execute( RANDOM_GRAPH ).close();
        assertExpectedResult( 0, algoQuery( "CALL algo.algo.closeness(null,nodes,' ')" ) );
    }
    ...
    public void shouldHaveExpectedBetweennessResultsForCypher()
    {
        ...
        Result result = db.execute("CALL algo.algo.betweennessCypher({write:true})");
    ...
    public void shouldHaveExpectedBetweennessNodeRemappingForCypher()
    {
        ...
        Result result = db.execute("CALL algo.algo.betweennessCypher({relCypher: \"MATCH (s:Company)-[r]->(t:Company) RETURN id(s) as source, id(t) as target, 1 as weight\"," +
                "write:true})");
        System.out.println(result.resultAsString());
