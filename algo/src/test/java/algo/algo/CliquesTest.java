...
import static algo.util.MapUtil.map;
...
public class CliquesTest {
    ...
    {
        Result result = db.execute( "CALL algo.algo.cliques(0)" );
    ...
    public void testCliquesFromGraphWithOneClique()
    {
        ...
        Result result = db.execute( "CALL algo.algo.cliques(0) YIELD clique as clique RETURN clique" );
    ...
    public void testCliquesFromGraphWithTwoCliquesAndExtraNodes()
    {
        ...
        Result result = db.execute( "CALL algo.algo.cliques(0) YIELD clique RETURN clique" );
    ...
    public void testCliquesFromSpecifcNode()
    {
        ...
        Result result = db.execute( "MATCH (n {n:{node}}) " +
                "CALL algo.algo.cliquesWithNode(n, 1) YIELD clique as clique " +
