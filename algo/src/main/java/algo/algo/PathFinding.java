...
import algo.result.PathResult;
import algo.result.WeightedPathResult;
...
public class PathFinding {
    ...
    @Procedure
    @Description("algo.algo.aStar(startNode, endNode, 'KNOWS|<WORKS_WITH|IS_MANAGER_OF>', 'distance','lat','lon') " +
    ...
    @Procedure
    @Description("algo.algo.aStar(startNode, endNode, 'KNOWS|<WORKS_WITH|IS_MANAGER_OF>', {weight:'dist',default:10," +
    ...
    @Procedure
    @Description("algo.algo.dijkstra(startNode, endNode, 'KNOWS|<WORKS_WITH|IS_MANAGER_OF>', 'distance') YIELD path," +
    ...
    @Procedure
    @Description("algo.algo.allSimplePaths(startNode, endNode, 'KNOWS|<WORKS_WITH|IS_MANAGER_OF>', 5) YIELD path, " +
    ...
    @Procedure
    @Description("algo.algo.dijkstraWithDefaultWeight(startNode, endNode, 'KNOWS|<WORKS_WITH|IS_MANAGER_OF>', " +
