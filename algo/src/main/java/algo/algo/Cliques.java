...
public class Cliques {
    ...
    @Procedure
    @Description("algo.algo.cliques(minSize) YIELD cliques - search the graph and return all maximal cliques at least at " +
    ...
    @Procedure
    @Description("algo.algo.cliquesWithNode(startNode, minSize) YIELD cliques - search the graph and return all maximal cliques that " +
