...
import static algo.algo.algorithms.AlgoUtils.SETTING_BATCH_SIZE;
import static algo.algo.algorithms.AlgoUtils.SETTING_WEIGHTED;
...
public class Centrality {
    ...
    @Procedure("algo.algo.betweenness")
    @Description("CALL algo.algo.betweenness(['TYPE',...],nodes,BOTH) YIELD node, score - calculate betweenness " +
    ...
    @Procedure(value = "algo.algo.betweennessCypher",mode = Mode.WRITE)
    @Description("CALL algo.algo.betweennessCypher(node_cypher,rel_cypher,write) - calculates betweeness " +
    " centrality based on cypher input")
    public Stream<algo.algo.algorithms.AlgorithmInterface.Statistics> betweennessCypher(
        ...
        algo.algo.algorithms.BetweennessCentrality betweennessCentrality =
                new algo.algo.algorithms.BetweennessCentrality(dbAPI, pool, log);
    ...
    @Procedure("algo.algo.closeness")
    @Description("CALL algo.algo.closeness(['TYPE',...],nodes, INCOMING) YIELD node, score - calculate closeness " +
            "centrality for given nodes")
