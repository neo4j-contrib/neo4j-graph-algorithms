...
// tag::intro[]
https://www.yelp.com/[Yelp.com] has been running https://www.yelp.com/dataset/challenge[Yelp Dataset challenge] since 2013.
...
We will store all the meta-data ( location of business etc.) as properties of nodes except for categories of the businesses, which are represented by separate nodes labeled `Category`.
