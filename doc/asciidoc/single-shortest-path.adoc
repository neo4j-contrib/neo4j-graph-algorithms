...
He needed to find a problem and solution that people not familiar with computing would be able to understand.
He designed what is now known as Dijkstra's algorithm and later implemented it for a slightly simplified transportation map of 64 cities in the Netherlands.
