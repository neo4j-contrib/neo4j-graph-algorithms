...
* it is used as part of the node2vec and graph2vec algorithms that create node embeddings.

* as part of the Walktrap and Infomap community detection algorithms.
...
* as part of the training process of machine learning model as describe in David Mack's article https://medium.com/octavian-ai/review-prediction-with-neo4j-and-tensorflow-1cd33996632a[Review prediction with Neo4j and TensorFlow^].
