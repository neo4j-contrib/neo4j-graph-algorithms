...
// tag::introduction[]
Jaccard similarity (coefficient) measures similarities between sets and the term was coined by https://en.wikipedia.org/wiki/Paul_Jaccard[Paul Jaccard^].
...
e.g. show me the products that were purchased by people similar to me in terms of previous products purchased
// end::use-case[]
