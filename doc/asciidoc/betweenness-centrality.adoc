...
// tag::explanation[]
The betweenness centrality algorithm calculates the shortest (weighted) path between every pair of nodes in a connected graph using a breadth-first search algorithm.
