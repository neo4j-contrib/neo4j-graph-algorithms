...
You will need to add/enable this line in your `$NEO4J_HOME/conf/neo4j.conf`
----
apoc.import.file.use_neo4j_config=true

// if you have 3.2.x version you also need to add
...
Triangle count : 82573393

Average clustering coefficient :  0.0523
...
Projecting a review similarity graph can be used for recommendations. We calculate similar pairs of users based on review ratings, so we can recommend to a user what similar users liked.
