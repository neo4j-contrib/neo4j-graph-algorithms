...
public class LabelPropagation {
    ...
    @Procedure(name = "algo.algo.community",mode = Mode.WRITE)
    @Description("CALL algo.algo.community(times,labels,partitionKey,type,direction,weightKey,batchSize) - simple label propagation kernel")
